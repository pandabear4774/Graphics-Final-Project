...
Coin::Coin( GLuint shaderProgramHandle, GLint mvpMtxUniformLocation, GLint normalMtxUniformLocation, GLint materialColorUniformLocation ) {
...
void Coin::drawCoin(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx) {
    ...
    glUniform3fv(_shaderProgramUniformLocations.materialColor, 1, &glm::vec3(1,1,0)[0]);
